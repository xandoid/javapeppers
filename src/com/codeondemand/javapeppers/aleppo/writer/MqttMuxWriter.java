...
public class MqttMuxWriter extends DestinationWriter {
    ...
    public boolean write(Object data) {
        ...
        if (data instanceof String && data.toString().trim().length() == 0) {
            ...
            String payload = null;
            String split = "";
            if (data instanceof RecordCapsule && ((RecordCapsule) data).getField("mqtt.split") != null) {
                split = ((RecordCapsule) data).getField("mqtt.split").getData().toString();
            ...
            if (pmap.containsKey("field")) {
                ...
                if (list.size() > 1) {
                    ...
                    Object d = ((RecordCapsule) data).getField((String) pmap.get("field")).getData();
        ...
        for (int i = 0; i < hostcount; i++) {
            ...
            if (stok.countTokens() == 8) {
                ...
                try {
                    ...
                    MqttPublisherThread t = new MqttPublisherThread(mqtt_pub, topics[0], null, bqos[0]);
