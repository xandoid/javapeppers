            ...
            if (record != null && record.toString().length() > 0) {
                if (pmap.containsKey("field") && record instanceof RecordCapsule) {
                    ...
                    if (((RecordCapsule) record).checkField(pfx + "output_file_name")) {
                        close();
                        initialized = initialize(path + ((RecordCapsule) record).getField(pfx + "output_file_name").getData().toString(), append);
                    }
                    ...
                    if (isBinary) {
                        ...
                        if (pmap.containsKey("field_delim")) {
                            ...
                            while (stok.hasMoreElements()) {
                                ...
                                if (((RecordCapsule) record).getField(tok) == null || ((RecordCapsule) record).getField(tok).isNull()) {
                                    wrtr.write(fdelim + tok + "");
                                } else {
                                    wrtr.write(fdelim + ((RecordCapsule) record).getField(tok).getData().toString().trim());
                                }
                                fdelim = delim;
                            }
                            wrtr.write("\n");
                            ...
                            if (((RecordCapsule) record).getField(field) != null && !((RecordCapsule) record).getField(field).isNull()) {
