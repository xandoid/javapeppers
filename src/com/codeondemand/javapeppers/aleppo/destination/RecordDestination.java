...
public class RecordDestination {
     ...
     *
     * @param w Specifies the DestinationWriter component for this object. If
     ...
     * @param b Specifies the DestinationWriter component for this object. If
     *          you pass a 'null' for the parameter, then a
    ...
    public boolean initialize(DestinationWriter w, RecordBuilder b) {
        ...
        // Set the writer
        if (w == null) {
            retval = retval && setDestinationWriter(new com.codeondemand.javapeppers.aleppo.writer.NullWriter());
            logger.debug("null object passed for writer, " + "instantiating a com.codeondemand.javapeppers.aleppo.writer.NullWriter object.");
        } else {
            retval = retval && setDestinationWriter(w);
            logger.debug("Initializing destination with writer: " + w.toString());
        }
        // Set the builder
        if (b == null) {
            retval = retval && setRecordBuilder(new com.codeondemand.javapeppers.aleppo.builder.NullBuilder());
            logger.debug("null object passed for builder, " + "instantiating a com.codeondemand.javapeppers.aleppo.builder.NullBuilder object.");
        } else {
     ...
     *
     * @param record The incoming RecordCapsule object.
     ...
     *
     * @param max The number of records you can send.
     */
