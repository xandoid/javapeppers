...
public class ReadTableMetaData extends RecordProcessor {
	...
	public RecordCapsule processRecord(RecordCapsule input) {
		...
		if ((input.checkField("SCHEMA") || input.checkField("TABLE_SCHEMA")) && input.checkField("TABLE_NAME")
				&& input.checkField("FIELDS") && con != null) {
			String schema = null;
	 ...
	 * 
	 * @param field
	 *            The name of the field. Usually derived from the header.
