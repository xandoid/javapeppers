...
public interface AbstractConcentrator {
	 ...
	 */
	public abstract RecordCapsule buildHeaderObject(RecordCapsule hdrRecord);
	 ...
	 */
	public abstract boolean checkKeys(RecordCapsule newkey, RecordCapsule oldkey);
