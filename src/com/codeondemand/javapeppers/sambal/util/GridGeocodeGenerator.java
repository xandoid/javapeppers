...
public class GridGeocodeGenerator extends RecordProcessor {
	...
	public boolean initialize( Object[] params){
		...
		if( params != null && params.length > 0 && params[0] instanceof TreeMap){
			...
			if( map.containsKey("min_lat") &&
			        map.containsKey("max_lat") &&
			        map.containsKey("min_long") &&
			        map.containsKey("max_long") &&
			        map.containsKey("lat_incr") &&
			        map.containsKey("long_incr") &&
			        map.containsKey("lat_tag") &&
			        map.containsKey("long_tag")
		       ){
