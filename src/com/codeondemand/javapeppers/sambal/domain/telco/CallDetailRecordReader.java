...
public class CallDetailRecordReader extends SourceReader{
	...
	private String getPhoneNumber(){
		...
		retval = ""+country_codes.get(rangen.nextInt(country_codes.size()))
			+area_codes.get(rangen.nextInt(area_codes.size()))
			+prefix_codes.get(rangen.nextInt(prefix_codes.size()))
			+ UtilityGenerator.generateRandomDigitString(number_length, true);
		return retval;
	}
