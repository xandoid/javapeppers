...
public class MqttConnector {
	 ...
	 */
	public MqttClient addConnection(String name, String client,
			MqttBrokerInfo broker, boolean cleanstart) {
	 ...
	 * @param client
	 *            A unique string to use when connection to the broker.
	 * @param broker
	 *            The MqttBrokerInfo object
	 * 
	 * @return An MqttClient object with a connection to the broker.
	 */
	public MqttClient addConnection(String name, String client,
			MqttBrokerInfo broker) {

		mqtt = null;
		if (broker != null) {
			logger.debug("Adding connection: " + name + ":" + client + ":"
					+ broker.getName());
	 ...
	 * 
	 * @param name
	 *            The name of the connection that should be retrieved.
	 * 
