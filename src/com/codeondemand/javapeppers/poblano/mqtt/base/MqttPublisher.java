...
public class MqttPublisher {
	 ...
	 * 
	 * @param topics
	 *            The topic on which the data will be published.
	 * @param message
	 *            The data to be published
	 * @param qos
	 *            The Quality of Service at which the publication should be
	 *            delivered.
	 * @param retained
	 *            Is this a retained publication or not?
	 * 
	 */
	public void publish(String[] topics, String message, byte qos,
