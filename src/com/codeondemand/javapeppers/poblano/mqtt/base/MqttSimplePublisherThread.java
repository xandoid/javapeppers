 ...
 * @author gfa
 */
public class MqttSimplePublisherThread extends MqttPublisher implements Runnable {
     ...
     */
    public MqttSimplePublisherThread(MqttClient mqtt, String topic, String message, byte qos) {
        this.mqtt = mqtt;
