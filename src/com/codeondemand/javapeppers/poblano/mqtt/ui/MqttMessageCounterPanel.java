...
public class MqttMessageCounterPanel {
    ...
    public void initialize(String pfile) {
        ...
        Properties app_properties = MiscUtil.loadXMLPropertiesFile(pfile);

        // Set up our initial connection information
        MqttBrokerInfo brokerInfo = new MqttBrokerInfo("CCAOE", app_properties.getProperty("brokerip"), app_properties.getProperty("brokerport"));
        MqttConnector c = new MqttConnector();
        @SuppressWarnings("unused") MqttClient mqtt = c.addConnection("foo", "msgCounter", brokerInfo);
