...
public class MiscUtil {
	 ...
	 * 
	 * @param in
	 *            The input stream to read from. If this is null, then System.in
	 *            will be assumed.
	 * @param prompt
	 *            The prompt string to pass to the user if the input stream is
	 ...
	 * 
	 * @param f
	 *            Specify the filename of the property file
	 * 
	 ...
	 * 
	 * @param in
	 *            The input stream to use for prompting. If this is null, then
	 *            System.in will be used (typically console).
	 * @param prompt
	 *            The string to use for prompting the user. You can set this to
	 ...
	 * 
	 * @param s
	 *            The String specifying the type
	...
	public static String replaceToken(String input, String token, String value) {
		...
		if (retval != null && (token != null) && (value != null)
				&& retval.contains(token.subSequence(0, token.length()))) {
	 ...
	 * 
	 * @param p
	 *            A Properties object that may contain the tokens that are
	 *            embedded in the string as keys.
	 * @param in
	 *            The input string.
	 * @param delim
	 *            The token delimiter that is potentially in the string.
	 ...
	 * 
	 * @param imei
	 *            - A 14 characters string consisting of numeric digits (0-9).
