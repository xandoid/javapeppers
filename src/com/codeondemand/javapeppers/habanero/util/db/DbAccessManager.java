...
public class DbAccessManager {
	 ...
	 * 
	 * @param url
	 *            The String containing a URL which specifies the database for
	 *            which connection is desired. This is the default url for this
	 *            DbAccessManager, but it can support multiple connections to
	 *            multiple databases.
	 * @param count
	 *            The number of connection Queues to create for contact with the
	 ...
	 * @param user
	 *            The database logon name for the request.
	 * @param password
	 *            The logon password for the request.
	 */
	public synchronized Connection getConnection(String url, String user,
			String password) {
		dbUser = user;
		dbPassword = password;
		...
		ConcurrentLinkedQueue<Connection> connectionQueue = connectionTable
				.get(url);
